...
\example The following details a sample Huffman encoding for letters A-E in a toy alphabet. 
\begin{figure}[h]
\centering
\includegraphics[scale=0.8]{huffman.png}
\end{figure}
...
\example The Huffman code works for $n$-ary trees. In particular, the same example above with a ternary division yields $E[\text{Length}] = 1.5$ ternary digits. 
...
%"I can't do the math" - Swapnil Garg, 9/28/2016
\end{document}