...
\subsection{Final Source Coding Examples}


\example[Huffman Codes with Costs] This is problem 17 from the text; the solution is in the image (for now). 

\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{weightedcoding.jpeg}
\end{figure}
