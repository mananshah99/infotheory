...
\example $X$ is a binomial R.V. with expected value 6 and variance 2.4. Find P\{X=5\}.
\example Suppose 2 4-sided dice with sides numbered 1-4. Let $X$ denote the sum of the dice. Find all values of $X$, the pmf of $X$, and $E[X]$.
\example $X$ is a R.V. having possible values of 0 \& 1. Such that P(X=0) = 2P(X=1). Find the pmf, E, and Var of $X$. 
\example Local soccer team has 5 more games to play. If it wins, they will play its final 4 games in upper bracket \& wins each game in this bracket is 0.4. If it plays in lower bracket, probability of winning is 0.7. Probability that it wins the game this weekend is 0.5, what is the probability that it wins at least 3 of final 4 games?
